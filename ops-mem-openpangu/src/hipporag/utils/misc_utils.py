...
class QuerySolution:
    ...
    answer: str = None
    # LoCoMo adaptation (optional; kept None for non-LoCoMo datasets)
    locomo_metadata: Optional[Dict[str, Any]] = None
    raw_answer: Optional[str] = None
    gold_answers: List[str] = None
    gold_docs: Optional[List[str]] = None
    episodic_memories: Optional[List[Any]] = None
    top_k_facts: Optional[List[Tuple]] = None  # Top-k facts retrieved and reranked for this query
